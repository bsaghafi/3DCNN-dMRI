# Purpose: tests a pretrained 3DCNN model to predict the level of head impact exposure from changes in FA images post-pre
# Inputs: delta FA maps (Post-Pre), their classification labels and the 3DCNN model
